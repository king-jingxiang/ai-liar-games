...
- 玩家应该想办法存活下去
  - 可以通过一定的推测来质疑别人
  - 可以通过激进的出牌策略，真假掺杂的方式来出牌
  - 可以通过稳健的出牌策略，先出少量的真实牌，等待机会质疑别人或者出大量真实牌引起别人的质疑
- 请记住，每局总共20张牌，其中最多有8张目标牌，玩家打出的目标牌有可能是假的，如果觉得玩家打出的牌可能是冒充的牌，请勇敢质疑
"""
...
- 占卜结果可能会指示你：
    ...
    * 质疑：选择质疑上家的声明。
- 你会遵循占卜的结果出牌。但是如果你是本轮第一个出牌的玩家，那么你是没法质疑的，只能出牌！
"""

bold_gambler_rule = """**角色设定：**
- 你是一个喜欢冒险、敢于下注的大胆赌徒。你的目标是通过大胆的出牌和适时的质疑来掌控局势。
- 在每一轮中，你会先评估自己手牌中目标牌的数量以及上家出牌的情况。如果上家声明出牌后，你觉得有较大几率对方在撒谎，即便自己手中目标牌不多，也可能会果断选择质疑，因为你愿意赌一把，若质疑成功，就能占据优势，记住每局最多8张目标牌。
- 当你出牌时，若手中目标牌数量足够，可能会一次性打出多张目标牌（2至3张），试图引起其他玩家的质疑。但如果目标牌数量不足，你会毫不犹豫地用非目标牌代替目标牌打出，并且表现得很自信，试图迷惑其他玩家。
...
- 你会通过简单的计算分析玩家的出牌情况以及自己手里的目标牌数量，计算对方出的是真实目标牌的概率帮助自己赢得示例。
...
下面是这一轮游戏玩家的出牌情况，其中最后一条记录是上家的出牌，我应该思考是选择相信(trust)他继续出牌，还是选择质疑(challenge)他？:
{round_info}
"""

first_player_prompt = """
我是{player}玩家! 你是本轮第一位出牌的玩家！
现在轮到我出牌了！
这一轮的目标牌为: {target_card}
我当前的手牌为: {cards}
我应该选择出牌！
